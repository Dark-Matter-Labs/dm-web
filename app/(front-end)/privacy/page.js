    ...
    >
      ...
      >
        ...
        <div>
          ...
          Dark Matter Labs (DML) is a strategic discovery, design and development lab working to transition society in response to technological revolution and climate breakdown. We run this website (darkmatterlabs.org/) and its subdomains (http://provocations.darkmatterlabs.org/).
          </p>
        </div>
        <p className="p-xl-regular text-[#EBEBEB]">
      ...
      >
        <p className="p-xl-regular text-[#EBEBEB]">
        Site Visitor: You are a site visitor when you visit and interact with our web sites, web pages, blogs and content on darkmatterlabs.org. Jump to Site Visitor.
        </p>
        <p className="p-xl-regular text-[#EBEBEB]">
        ...
        <p className="p-xl-regular text-[#EBEBEB]">Partner: You are an existing Partner once you have engaged with Dark Matter Labs in a contract. Jump to Partner.</p>
        <p className="p-xl-regular text-[#EBEBEB]">Prospective Applicant: You are a Prospective Applicant when you apply to a position at Dark Matter Labs that are found here. Jump to Prospective Applicant.</p>
        <p className="p-xl-regular text-[#EBEBEB]">Event Attendee: We occasionally host events at Dark Matter Labs that require your registration, you are an Event Attendee once you have registered for an event that we are hosting. Jump to Event Attendee.
</p>
      </div>
      ...
      >
        ...
        <p className="p-xl-regular text-[#EBEBEB]">Storage limitation: Don't store personal data for longer than you need to.</p>

        <p className="p-xl-regular text-[#EBEBEB]">Integrity and confidentiality: Always process personal data securely.
        </p>

        <p className="p-xl-regular text-[#EBEBEB]">hese principles build the foundation for why data is being collected and all of the data that DML is collecting has to fall in line with one of these six principles.</p>
      </div>

      <div className="col-span-5 mt-16 w-full sm:w-[690px] md:w-[400px] md:self-start">
        <h2 className="heading-5xl-Reg max-w-xs pb-2 text-grey-3">Site Visitor</h2>
      </div>
      <div
        className={
      ...
      >
        ...
        <ul className="p-xl-regular list-disc pl-3 text-[#EBEBEB]">
          ...
          <h2 className="heading-4xl text-[#EBEBEB]">Why we collect website data</h2>
        <p className="p-xl-regular text-[#EBEBEB]">
        ...
        <h2 className="heading-4xl text-[#EBEBEB]">Where website data is processed and stored</h2>
        <p className="p-xl-regular text-[#EBEBEB]">
        We use an analytics software run through <a href="https://www.cloudflare.com/">Cloudflare</a>, a service that adopts a privacy-first analytics approach. This means that they enable us to analyze traffic to our website, without compromising our users’ privacy. Their approach to customer data is outlined in their <a href="https://www.cloudflare.com/privacypolicy/">privacy policy</a> and the data that we have access to is only visible for 30 days
        </p>
...
<p className="p-xl-regular text-[#EBEBEB]">
  DML’s website is hosted by Vercel, their approach to GDPR is highlighted here and also reflected in their <a href="https://vercel.com/legal/privacy-policy">Privacy Policy</a>.
</p>
...
<h2 className="heading-4xl text-[#EBEBEB]">Our social media accounts</h2>
<p className="p-xl-regular text-[#EBEBEB]">
...
<ul className="p-xl-regular text-[#EBEBEB]">
  <li>Dark Matter Labs on <a href="#" className="text-link">Twitter (Privacy policy)</a></li>
  <li>Dark Matter Labs on <a href="#" className="text-link">LinkedIn (Privacy policy)</a></li>
  <li>Dark Matter Labs on <a href="#" className="text-link">Medium (Privacy policy)</a></li>
  <li>Dark Matter Labs on <a href="#" className="text-link">Instagram (Privacy policy)</a></li>
</ul>
...
<p className="p-xl-regular text-[#EBEBEB]">We collect the following information from research participants:</p>
...
<h3 className="heading-4xl text-[#EBEBEB]">How long we keep research data</h3>
<p className="p-xl-regular text-[#EBEBEB]">
...
<h3 className="heading-4xl text-[#EBEBEB]">Where research data is processed and stored</h3>
<p className="p-xl-regular text-[#EBEBEB]">
...
<p className="p-xl-regular text-[#EBEBEB]">
  Participants are able to withdraw their information from a project at any time. To do this, contact <a href="mailto:info@darkmatterlabs.org" className="text-link">info@darkmatterlabs.org</a>.
</p>
...
<h3 className="heading-4xl text-[#EBEBEB]">How long we keep this data</h3>
<p className="p-xl-regular text-[#EBEBEB]">
...
<h3 className="heading-4xl text-[#EBEBEB]">Where data about potential and existing partners is processed</h3>
<p className="p-xl-regular text-[#EBEBEB]">
...
<h3 className="heading-4xl text-[#EBEBEB]">How long we keep Attendee data</h3>
<p className="p-xl-regular text-[#EBEBEB]">
...
<h3 className="heading-4xl text-[#EBEBEB]">Where Attendee data is processed and stored</h3>
<p className="p-xl-regular text-[#EBEBEB]">
...
<h3 className="heading-4xl text-[#EBEBEB]">Opt-out of collection</h3>
<p className="p-xl-regular text-[#EBEBEB]">
  Attendees are able to withdraw their information at any time. To do this, contact <a href="mailto:info@darkmatterlabs.org" className="text-link">info@darkmatterlabs.org</a>.
</p>
        </div>
...
<h3 className="heading-4xl text-[#EBEBEB]">Why we collect recruitment data</h3>
<p className="p-xl-regular text-[#EBEBEB]">
  Recruitment data is used to assess suitability for a role and to help us communicate with candidates.
</p>

<h3 className="heading-4xl text-[#EBEBEB]">How long we keep recruitment data</h3>
<p className="p-xl-regular text-[#EBEBEB]">
...
<h3 className="heading-4xl text-[#EBEBEB]">Right to restrict processing</h3>
<p className="p-xl-regular text-[#EBEBEB]">
...
<h3 className="heading-4xl text-[#EBEBEB]">Right to object to processing</h3>
<p className="p-xl-regular text-[#EBEBEB]">
  You have the right to object to Dark Matter Labs processing your personal data under certain conditions.
</p>

<h3 className="heading-4xl text-[#EBEBEB]">Right to data portability</h3>
<p className="p-xl-regular text-[#EBEBEB]">
...
<h3 className="heading-4xl text-[#EBEBEB]">Right to object to your data processing</h3>
<p className="p-xl-regular text-[#EBEBEB]">
...
<h3 className="heading-4xl text-[#EBEBEB]">Rights related to automated decision-making, including profiling</h3>
<p className="p-xl-regular text-[#EBEBEB]">
...
<p className="p-xl-regular text-[#EBEBEB]">
  To exercise any of these rights, please contact us at <a href="mailto:info@darkmatterlabs.org" className="text-link">info@darkmatterlabs.org</a>. We will respond to all requests within 28 days of receiving them.
</p>

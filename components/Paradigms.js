...
export default function Paradigms({setOpenNE, setOpenRC, setOpenSM, setOpenRE,  setOpenCT,  setOpenPC, setOpenPB,  setOpenBR, setOpenCD, setOpenQD,  setOpenETC, setOpenOD,  setOpenBE, setOpenSG, setOpenCS, setOpenM0, setOpenNZ}){
  return(
    <>

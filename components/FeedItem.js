...
export default function FeedItem({ item }) {
  return (
    <div
      key={item.title}
      className="group flex h-full flex-col items-center justify-center sm:gap-[40px] border-b border-b-[#353535] hover:cursor-crosshair sm:flex-row sm:items-start sm:justify-between"
    >

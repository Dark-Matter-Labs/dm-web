    ...
    <Dialog open={openState} onClose={setOpen} className="relative z-60">
      ...
      <div className="fixed inset-0 overflow-y-auto">
        <div className="flex min-h-full items-end justify-center text-center sm:items-center">
          <DialogPanel
            transition
            className="shadow-layer relative flex h-auto w-4/5 transform items-center justify-center overflow-hidden border-[0.5px] border-[#353535] bg-[#161618] text-left transition-all data-closed:translate-y-4 data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in sm:w-[690px] sm:items-start sm:justify-start data-closed:sm:translate-y-0 data-closed:sm:scale-95"
          >
            {domain === 'A' ? (
            ...
            <div className="flex flex-col items-start justify-start gap-[16px] border-l-[0.5px] border-[#353535] py-[28px] pr-[32px] pl-[28px]">

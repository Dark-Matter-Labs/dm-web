          ...
          <div className={`relative col-span-8`}>
            ...
            <div className={`${classT2}`}>
              <div className="h-screen font-FKregular ">
                <div className={``}>
                  <div
                    className={`threeD absolute z-50 grid h-full w-full grid-cols-12 ${animateOn} shadow-layer`}
                  >
                    ...
                    <div className="col-span-11 ">
                      ...
                      <div className="grid grid-cols-9">
                        <div className="studio-layer">
                          {/* <div
                            className={`my-1.5 flex h-[80px] flex-col justify-between  px-1.5 py-2  opacity-0`}
                          ></div> */}

                          <div
                            className={`my-1.5  flex h-[80px] flex-col items-center justify-center`}
                          ></div>

                          <div className={`my-1.5 h-[80px]`}> </div>

                          <div
                            className={`my-1.5  h-[80px] px-2  py-[2.14rem]`}
                          >
                            {' '}
                          </div>
                          ...
                          <div
                            className={`py-[2.14rem my-1.5 flex h-[80px] flex-col  items-center justify-center`}
                          ></div>
                        ...
                        <div className="studio-layer">
                          {/* <div
                            className={`flex flex-col justify-between px-1.5py-[2.14rem] text-[#A8A8A8] opacity-0   h-[80px]`}
                          ></div> */}
